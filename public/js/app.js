...
},{"../core/createError":6,"./../core/settle":9,"./../helpers/btoa":13,"./../helpers/buildURL":14,"./../helpers/cookies":16,"./../helpers/isURLSameOrigin":18,"./../helpers/parseHeaders":20,"./../utils":22,"_process":28}],3:[function(require,module,exports){
'use strict';
...
},{"../adapters/http":2,"../adapters/xhr":2,"./../utils":22,"./transformData":10,"_process":28}],8:[function(require,module,exports){
'use strict';
...
},{"domify":24,"form-serialize":26}],32:[function(require,module,exports){
(function (global){
...
},{"classlist-polyfill":23,"domify":24,"es6-object-assign":25}],33:[function(require,module,exports){
'use strict';
...
},{"./axios":34,"./elements/hazards":36,"./templates/accident_template":38,"jquery":27}],34:[function(require,module,exports){
'use strict';
...
function init() {
	...
	if (ca != null) for (var i = 0; i < ca.length; i++) {
...
if (!actualPage.includes('stepone') && !actualPage.includes('steptwo')) {
  ...
  (function () {
    ...
    $ = require('jquery');
    Hazard = require('./elements/hazards');
    //var State = require('./elements/states');

    ControlActions = require('./elements/controlactions');
    ...
    //State.init();
    ControlActions.init();
    fundamentals = ['hazard', 'component', 'systemgoal', 'accident', 'systemsafetyconstraint', 'variable-0'];
    ...
    axios = require('./axios');
    functions = require('./ajax_functions');
    systemgoal = require('./templates/systemgoal_template');
    accident = require('./templates/accident_template');
    hazard = require('./templates/hazard_template');
    actuator = require('./templates/actuator_template');
    controlledprocess = require('./templates/controlledprocess_template');
    sensor = require('./templates/sensor_template');
    component = require('./templates/component_template');
    connection = require('./templates/connection_template');
    controlaction = require('./templates/controlaction_template');
    variable = require('./templates/variable_template');
    accident = require('./templates/connection_template');
    state = require('./templates/state_template');
    addstate = require('./templates/add-state_template');
    systemsafetyconstraint = require('./templates/systemsafetyconstraint_template');
  ...
  (function () {
    ...
    UCA = require('./templates/unsafecontrolaction_template');
    uca = [];
  ...
  (function () {
    ...
    axios = require('./axios');
    newCausal = require('./templates/causal_template');
    vex = require('vex-js');
...
module.exports = function (context) {
    ...
    if (context.guideword == 1) select += "<option value=\"1\" title=\"Control input or external information wrong or missing\" selected>[Control input or external information wrong or missing]</option>";else select += "<option value=\"1\" title=\"Control input or external information wrong or missing\">[Control input or external information wrong or missing]</option>";

    if (context.guideword == 2) select += "<option value=\"2\" title=\"Inadequate Control Algorithm\" selected>[Inadequate Control Algorithm]</option>";else select += "<option value=\"2\" title=\"Inadequate Control Algorithm\">[Inadequate Control Algorithm]</option>";

    if (context.guideword == 3) select += "<option value=\"3\" title=\"Process Model inconsistent, incorrect or incomplete\" selected>[Process Model inconsistent, incorrect or incomplete]</option>";else select += "<option value=\"3\" title=\"Process Model inconsistent, incorrect or incomplete\">[Process Model inconsistent, incorrect or incomplete]</option>";

    if (context.guideword == 4) select += "<option value=\"4\" title=\"Inappropriate, ineffective or missing control action\" selected>[Inappropriate, ineffective or missing control action]</option>";else select += "<option value=\"4\" title=\"Inappropriate, ineffective or missing control action\">[Inappropriate, ineffective or missing control action]</option>";

    if (context.guideword == 5) select += "<option value=\"5\" title=\"Inadequate Operation\" selected>[Inadequate Operation]</option>";else select += "<option value=\"5\" title=\"Inadequate Operation\">[Inadequate Operation]</option>";

    if (context.guideword == 6) select += "<option value=\"6\" title=\"Delayed Operation\" selected>[Delayed Operation]</option>";else select += "<option value=\"6\" title=\"Delayed Operation\">[Delayed Operation]</option>";

    if (context.guideword == 7) select += "<option value=\"7\" title=\"Conflicting Control Actions\" selected>[Conflicting Control Actions]</option>";else select += "<option value=\"7\" title=\"Conflicting Control Actions\">[Conflicting Control Actions]</option>";

    if (context.guideword == 8) select += "<option value=\"8\" title=\"Component Failures\" selected>[Component Failures]</option>";else select += "<option value=\"8\" title=\"Component Failures\">[Component Failures]</option>";

    if (context.guideword == 9) select += "<option value=\"9\" title=\"Changes over time\" selected>[Changes over time]</option>";else select += "<option value=\"9\" title=\"Changes over time\">[Changes over time]</option>";

    if (context.guideword == 10) select += "<option value=\"10\" title=\"Process Input missing or wrong\" selected>[Process Input missing or wrong]</option>";else select += "<option value=\"10\" title=\"Process Input missing or wrong\">[Process Input missing or wrong]</option>";

    if (context.guideword == 11) select += "<option value=\"11\" title=\"Unidentified or out-of-range disturbance\" selected>[Unidentified or out-of-range disturbance]</option>";else select += "<option value=\"11\" title=\"Unidentified or out-of-range disturbance\">[Unidentified or out-of-range disturbance]</option>";

    if (context.guideword == 12) select += "<option value=\"12\" title=\"Process output contributes to hazard\" selected>[Process output contributes to hazard]</option>";else select += "<option value=\"12\" title=\"Process output contributes to hazard\">[Process output contributes to hazard]</option>";

    if (context.guideword == 13) select += "<option value=\"13\" title=\"Feedback delays\" selected>[Feedback delays]</option>";else select += "<option value=\"13\" title=\"Feedback delays\">[Feedback delays]</option>";

    if (context.guideword == 14) select += "<option value=\"14\" title=\"Measurement inaccuracies\" selected>[Measurement inaccuracies]</option>";else select += "<option value=\"14\" title=\"Measurement inaccuracies\">[Measurement inaccuracies]</option>";

    if (context.guideword == 15) select += "<option value=\"15\" title=\"Incorrect or no information provided\" selected>[Incorrect or no information provided]</option>";else select += "<option value=\"15\" title=\"Incorrect or no information provided\">[Incorrect or no information provided]</option>";

    if (context.guideword == 16) select += "<option value=\"16\" title=\"Inadequate Operation\" selected>[Inadequate Operation]</option>";else select += "<option value=\"16\" title=\"Inadequate Operation\">[Inadequate Operation]</option>";

    if (context.guideword == 17) select += "<option value=\"17\" title=\"Feedback Delays\" selected>[Feedback Delays]</option>";else select += "<option value=\"17\" title=\"Feedback Delays\">[Feedback Delays]</option>";

    if (context.guideword == 18) select += "<option value=\"18\" title=\"Inadequate or missing feedback\" selected>[Inadequate or missing feedback]</option>";else select += "<option value=\"18\" title=\"Inadequate or missing feedback\">[Inadequate or missing feedback]</option>";
