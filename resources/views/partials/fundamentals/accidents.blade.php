        ...
        @foreach ($accidents as $accident)
            <li class="item" id="accident-{{$accident->id}}">
                <div class="item__title">
                    A-{{$accident->id}}: <input type="text" class="item__input" id="accident-description-{{$accident->id}}" value="{{ $accident->name }}">
                </div>
                <div class="item__actions">
                    <form action ="/editaccident" method="POST" class="edit-form ajaxform" data-edit="accident">
                        <div class="item__title">
                            ...
                            <!--<a href="#edit-accident" rel="modal" data-index="{{$accident->id}}" data-value="{{$accident->name}}" class="edit-accident">-->
